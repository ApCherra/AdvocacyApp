...
void main() {
  ...
  final TestWidgetsFlutterBinding binding = TestWidgetsFlutterBinding.ensureInitialized();
    testWidgets('Testing if Celebrations Page is clickable.', (WidgetTester tester) async {
     ...
     nock('https://')
      ...
      await tester.tap(find.byKey(Key('SignIn')));
        ...
        await tester.tap(find.byIcon(Icons.attractions_outlined));
            await tester.pumpAndSettle();

        expect(find.byKey(Key('CelebrationsKey')), findsAny);
